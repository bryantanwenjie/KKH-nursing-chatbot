...
can make the chatbar similiar to the one shown in the image? and also the chat history should be fresh and will update if the user clicks on a new chat.